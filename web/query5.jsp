...
<div class="container">
    <h4>Query 5</h4>
    <p class="lead">English query: List the airports located in Texas and California.  </p>
    <p class="lead"><b>SQL: SELECT *
        FROM airport
        WHERE loc_code IN (SELECT loc_code FROM location
        WHERE loc_code='TX' OR loc_code='CA');</b></p>
    <form action="QueriesServlet" method="post">
        <input type="hidden" name="qid" value="query5">
