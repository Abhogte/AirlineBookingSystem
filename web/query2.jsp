...
<div class="container">
    <h4>Query 2</h4>
    <p class="lead">English query: Which are the cheapest flight from Arizona to Utah?  </p>
    <p class="lead"><b>SQL: SELECT F.flight_no, R.route_name, MIN(f.fare)
        FROM FLIGHT F JOIN ROUTE R ON F.flight_no = R.flight_no WHERE R.route_name = 'AZ->UT' AND f.remaining_seats > 0
        GROUP BY F.flight_no, r.route_name;</b></p>
    <form action="QueriesServlet" method="post">
        <input type="hidden" name="qid" value="query2">
