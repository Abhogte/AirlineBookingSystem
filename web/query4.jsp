...
<div class="container">
    <h4>Query 4</h4>
    <p class="lead">English query: Can I get the list of flights from California to any destination sorted based on price?  </p>
    <p class="lead"><b>SQL: SELECT F.flight_no, R.route_name, f.fare, f.remaining_seats
        FROM FLIGHT F JOIN ROUTE R ON F.flight_no = R.flight_no
        WHERE R.SOURCE_CODE = 'CA' AND f.remaining_seats > 0
        ORDER BY f.fare;</b></p>
    <form action="QueriesServlet" method="post">
        <input type="hidden" name="qid" value="query4">
