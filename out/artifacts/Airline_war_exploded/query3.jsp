...
<div class="container">
    <h4>Query 3</h4>
    <p class="lead">English query: Can I get the flights whose fare are between #baseFare to #topFare dollars?  </p>
    <p class="lead"><b>SQL: SELECT FLIGHT_NO, FARE, NO_OF_SEATS, AIRLINE_CODE
        FROM FLIGHT
        WHERE FARE BETWEEN #baseFare AND #topFare;</b></p>
    <form action="QueriesServlet" method="post">
        <input type="hidden" name="qid" value="query3">
        <input type="text"  name="fare1" placeholder="Base fare" required/><br><br>
        <input type="text"  name="fare2" placeholder="Top fare" required/> <br><br>
    ...
    <%
        ...
        if( flight != null && flight.size() > 0 && comment==null) {
    %>
