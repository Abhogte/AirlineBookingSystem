...
<div class="container">
    <h4>Query 7</h4>
    <p class="lead">English query: What is the baggage allowance for the airline #airlineName?  </p>
    <p class="lead"><b>SQL: SELECT baggage_allowance
        FROM airline
        WHERE airline_name = #airlineName;</b></p>
    <form action="QueriesServlet" method="post">
        <input type="hidden" name="qid" value="query7">
